...
export class NavigationViewModel extends BaseViewModel {
    ...
    public playTextAndCloseOpk(msg: string) {
        let listener = new TextListener();
        listener.setFinish(() => {
            // 播放完成
            listener.removeListener();
    ...
    public closeCurrentOpk() {
        ...
        this.myLog('2222 closeCurrentOpk >>>>>>>>>>.')
        ...
        this.nowBizState(common.CONST_CLOSE_CURRENT_OPK,"")
    }

    public nowBizState(type: any, moveErrorMsg: any) {
        DeviceEventEmitter.emit('bizState', type,moveErrorMsg )
    }
    ...
    //  * 点击开始导航
    //  */
    // public onPressStartNavigation = (): void => {
     ...
     * 点击开始导航
     */
    public onPressStartNavigation = (place: any): void => {
        this.mModel.startNavigation(place);
    };
    ...
    public startGoBack() {
        //0是现在去重置/注销地点, 1是现在要去接待点
        this.indexInt = 1
        this.onPressStartNavigation(this.backPlace)
    }
            ...
            switch (event.status) {
                case ComponentResultConst.RESULT_NAVIGATION_ARRIVED:
                    ...
                    if (this.indexInt == 0) {
                        ...
                        this.mModel.appendResultText(
                            '>>>>>>>>>1  成功到达目的地  <<<<<<<<<<  indexInt = ' + this.indexInt);

                        console.log('>>>>>>>>>1  成功到达目的地  <<<<<<<<<<  indexInt = ' + this.indexInt);

                        this.indexInt = 1
                        
                        this.nowBizState(common.CONST_TARGET_PLACE_SUCCESS,"")
                    }
                    //到达接待点
                    else if (this.indexInt == 1) {

                        this.mModel.appendResultText(
                            '>>>>>>>>>2  成功到达目的地  <<<<<<<<<<  indexInt = ' + this.indexInt);

                        console.log('>>>>>>>>>2  成功到达目的地  <<<<<<<<<<  indexInt = ' + this.indexInt);

                        this.indexInt = 2
                        // this.nowBizState(common.CONST_BACK_SUCCESS,"")
                        this.closeCurrentOpk()
                    }
                ...
                case ComponentResultConst.RESULT_NAVIGATION_FAILURE:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('底盘启动导航任务失败')
                ...
                case ComponentErrorConst.ERROR_PARAMS_PLACE_NAME_INVALID:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('地点名称参数无效')
                ...
                case ComponentErrorConst.ERROR_NOT_ESTIMATE:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('未定位异常')
                ...
                case ComponentErrorConst.ERROR_NAVIGATION_ALREADY_IN_DESTINATION:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('已经处于目标点位置')
                ...
                case ComponentErrorConst.ERROR_DESTINATION_NOT_EXIST:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('目标点不存在')
                ...
                case ComponentErrorConst.ERROR_REQUEST_RES_BUSY:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('申请机器人底盘资源正在占用')
                ...
                case ComponentErrorConst.ERROR_REQUEST_RES_FAILED:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('申请机器人底盘资源失败')
                ...
                case ComponentErrorConst.ERROR_NAVIGATION_OUT_MAP:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('目标点在地图外或在糟点上')
                ...
                case ComponentErrorConst.ERROR_NAVIGATION_GLOBAL_PATH_FAILED:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('全局路径规划失败')
                ...
                case ComponentErrorConst.ERROR_NAVIGATION_RESET_ESTIMATE_FAIL:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('重定位失败')
                ...
                case ComponentErrorConst.ERROR_DESTINATION_CAN_NOT_ARRIVE:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('机器无位移超时')
                ...
                case ComponentErrorConst.ERROR_NAVIGATION_AVOID_TIMEOUT:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('堵死状态超时')
                ...
                case ComponentErrorConst.ERROR_PARAMS_JSON_PARSER_ERROR:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('参数解析错误')
                ...
                case ComponentErrorConst.ERROR_WHEEL_OVER_CURRENT_RUN_OUT:
                    this.mModel.appendResultText(
                        ...
                        this.playTextAndCloseOpk('过流重试结束')
