...
/**** 社保卡解挂 */
@observer
export class CardUnhangScreen extends MyBaseComponent {
                            ...
                            <View style={styles.containerCenter2}>
                                ...
                                <View style={styles.containerLeft}>
                                    ...
                                    <View style={{ flex: 1 }} >
                                        <BusinessAnswerView
                                            ...
                                            atlasId={common.CONST_ATLAS_ID_SSC_SOLUTION_HANG}
                                            businessQuestion={common.CONST_BUSINESS_Q_SSC_SOLUTION_HANG}
                                            businessCompleteQ={common.CONST_BUSINESS_COMPLETE_SSC_SOLUTION_HANG}
                                ...
                                <View style={styles.containerRight}>
                                    ...
                                    <View style={[styles.containerStyle, { marginBottom: 0 }]}>
                                        ...
                                        {ViewUtils.getConfirmButton(() => this.commitData(), "确定解挂")}
                                    </View>
                                </View>
