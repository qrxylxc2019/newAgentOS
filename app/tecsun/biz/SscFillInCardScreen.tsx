...
/**** 社保卡补换 */
@observer
export class SscFillInCardScreen extends MyBaseComponent {

    public constructor(props: BaseComponentProps) {
        super(props);

        console.log('SscFillInCardScreen constructor');
                                ...
                                <View style={styles.containerLeft}>
                                    ...
                                    <View style={{ flex: 1 }} >
                                        <BusinessAnswerView
                                            ...
                                            atlasId={common.CONST_ATLAS_ID_SSC_Fill_In}
                                            businessQuestion={common.CONST_BUSINESS_Q_SSC_Fill_In}
                                            businessCompleteQ={common.CONST_BUSINESS_COMPLETE_SSC_Fill_In}
                    ...
                    <Modal
                        ...
                        >
                            <CommitResultView onTimeOut={() =>
                                this.jump2AnswerPage(common.CONST_BUSINESS_COMPLETE_SSC_Fill_In)
                            } />
