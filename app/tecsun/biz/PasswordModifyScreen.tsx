...
/**** 社保卡密码修改 */
@observer
export class PasswordModifyScreen extends MyBaseComponent {
    ...
    public constructor(props: BaseComponentProps) {
        ...
        this.handleInputSscPwdOldtext = this.handleInputSscPwdOldtext.bind(this);
        this.handleInputSscPwdNewtext = this.handleInputSscPwdNewtext.bind(this);
        this.handleInputSscPwdNew2text = this.handleInputSscPwdNew2text.bind(this);

    }

    //社保卡密码
    public handleInputSscPwdOldtext(text: any) {
        this.setState({ sscPwdOld: text });
    }

    public handleInputSscPwdNewtext(text: any) {
        this.setState({ sscPwdNew: text });
    }


    public handleInputSscPwdNew2text(text: any) {
        this.setState({ sscPwdNew2: text });
    }
    ...
    public commitData() {
        ...
        this.myLog("current >>>> ")
        this.myLog(current)
        let jian = current - this.lastTime
        this.myLog("jian >>>> ")
        this.myLog(jian)
        ...
        let sscPwdOld = this.state.sscPwdOld
        let sscPwdNew = this.state.sscPwdNew
        let sscPwdNew2 = this.state.sscPwdNew2

        this.myLog('sscPwdOld >>>>>')
        this.myLog(sscPwdOld)


        if (sscPwdOld == null || sscPwdOld == "null" || sscPwdOld == '' || sscPwdOld == "undefined" || sscPwdOld.length < 6) {

            this.toast('请输入正确的社保卡密码')

            return
        }

        if (sscPwdNew == null || sscPwdNew == "null" || sscPwdNew == '' || sscPwdNew == "undefined" || sscPwdNew.length < 6) {

            this.toast('请输入正确的新社保卡密码')

            return
        }
        if (sscPwdNew2 == null || sscPwdNew2 == "null" || sscPwdNew2 == '' || sscPwdNew2 == "undefined" || sscPwdNew2.length < 6) {

            this.toast('请再次输入正确的新社保卡密码')

            return
        }

        if (sscPwdNew != sscPwdNew2) {
                ...
                <MyMonitorView style={{ flex: 1 }} monitorTouch={() => {
                    ...
                    <View style={styles.container} >
                        ...
                        <View style={styles.containerCenter}>
                            ...
                            <TitleTopView titleText="社保卡密码修改" />
                            ...
                            <View style={styles.containerCenter2}>
                                ...
                                <View style={styles.containerLeft}>
                                    ...
                                    <View style={{ flex: 1 }} >
                                        <BusinessAnswerView
                                            ...
                                            atlasId={common.CONST_ATLAS_ID_PWD_CHANGE}
                                            businessQuestion={common.CONST_BUSINESS_Q_PWD_CHANGE}
                                            businessCompleteQ={common.CONST_BUSINESS_COMPLETE_PWD_CHANGE}
                                ...
                                <View style={styles.containerRight}>
                                    ...
                                    <View style={[styles.containerStyle, { marginTop: 5, width: '60%' }]}>
                                    ...
                                    <View style={[styles.containerStyle, { marginTop: 5, width: '60%' }]}>
                                        <Text style={styles.textStyle2} >社保卡旧密码:</Text>
                                        <View style={styles.containerStyle2}>
                                            <TextInput
                                                style={styles.inputStyle}
                                                placeholder="请输入社保卡旧密码"
                                                placeholderTextColor={'#b4b4b4'}
                                                value={this.state.sscPwdOld}
                                                maxLength={6}
                                                secureTextEntry={true}
                                                keyboardType='number-pad'
                                                onChangeText={newText => this.handleInputSscPwdOldtext(newText)}>
                                            </TextInput>
                                        </View>
                                    ...
                                    <View style={[styles.containerStyle, { marginTop: 5, width: '60%' }]}>
                                        <Text style={styles.textStyle2} >社保卡新密码:</Text>
                                        <View style={styles.containerStyle2}>
                                            <TextInput
                                                style={styles.inputStyle}
                                                placeholder="请输入社保卡新密码"
                                                placeholderTextColor={'#b4b4b4'}
                                                value={this.state.sscPwdNew}
                                                maxLength={6}
                                                secureTextEntry={true}
                                                keyboardType='number-pad'
                                                onChangeText={newText => this.handleInputSscPwdNewtext(newText)}>
                                            </TextInput>
                                        </View>
                                    ...
                                    <View style={[styles.containerStyle, { marginTop: 5, width: '60%' }]}>
                                        ...
                                        <View style={styles.containerStyle2}>
                                            <TextInput
                                                style={styles.inputStyle}
                                                placeholder="请再次输入社保卡新密码"
                                                placeholderTextColor={'#b4b4b4'}
                                                value={this.state.sscPwdNew2}
                                                maxLength={6}
                                                secureTextEntry={true}
                                                keyboardType='number-pad'
                                                onChangeText={newText => this.handleInputSscPwdNew2text(newText)}>
                                            </TextInput>
                                        </View>
                                    ...
                                    <View style={[styles.containerStyle, { marginTop: 5, width: '50%' }]}>
                                    ...
                                    <View style={[styles.containerStyle, { marginBottom: 0 }]}>
                                        ...
                                        {ViewUtils.getConfirmButton(() => this.commitData(), "确定修改")}
                                    </View>
                                </View>
                    ...
                    <Modal
                        ...
                        >
                            <CommitResultView onTimeOut={() =>
                                this.jump2AnswerPage(common.CONST_BUSINESS_COMPLETE_PWD_CHANGE)
                            } />
