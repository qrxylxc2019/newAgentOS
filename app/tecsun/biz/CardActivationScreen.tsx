...
/**** 社保卡激活 */
@observer
export class CardActivationScreen extends MyBaseComponent {
    ...
    public constructor(props: BaseComponentProps) {
        ...
        this.state = {
            ...
            cardActiveState: this.props.cardActiveState || '未激活',
                            ...
                            <View style={styles.containerCenter2}>
                                ...
                                <View style={styles.containerLeft}>
                                    ...
                                    <View style={{ flex: 1 }} >
                                        <BusinessAnswerView
                                            ...
                                            atlasId={common.CONST_ATLAS_ID_SSC_ACTIVE}
                                            businessQuestion={common.CONST_BUSINESS_Q_SSC_ACTIVE}
                                            businessCompleteQ={common.CONST_BUSINESS_COMPLETE_SSC_ACTIVE}
                                ...
                                <View style={styles.containerRight}>
                                    ...
                                    <View style={[styles.containerStyle, { marginBottom: 0 }]}>
                                        ...
                                        {ViewUtils.getConfirmButton(() => this.commitData(), "确认激活")}
                                    </View>
                                </View>
                    ...
                    <Modal
                        ...
                        >
                            <CommitResultView onTimeOut={() =>
                                this.jump2AnswerPage(common.CONST_BUSINESS_COMPLETE_SSC_ACTIVE)
                            } />
