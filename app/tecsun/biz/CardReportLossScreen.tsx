...
/**** 社保卡挂失 */
@observer
export class CardReportLossScreen extends MyBaseComponent {
    ...
    public constructor(props: BaseComponentProps) {
        ...
        this.handleInputSscPwdtext = this.handleInputSscPwdtext.bind(this);

    }

    //社保卡密码
    public handleInputSscPwdtext(text: any) {
        this.setState({ sscPwd: text });
    }
    ...
    public commitData() {
        ...
        let sscPwdOld = this.state.sscPwd
                        ...
                        <View style={styles.containerCenter}>
                            ...
                            <View style={styles.containerCenter2}>
                                ...
                                <View style={styles.containerLeft}>
                                    ...
                                    <View style={{ flex: 1 }} >
                                        <BusinessAnswerView
                                            ...
                                            atlasId={common.CONST_ATLAS_ID_SSC_LOSS}
                                            businessQuestion={common.CONST_BUSINESS_Q_SSC_LOSS}
                                            businessCompleteQ={common.CONST_BUSINESS_COMPLETE_SSC_LOSS}
                                ...
                                <View style={styles.containerRight}>
                                    ...
                                    <View style={[styles.containerStyle, { marginTop: 5, width: '50%' }]}>
                                        <Text style={styles.textStyle2} >社保卡密码:</Text>
                                        <View style={styles.containerStyle2}>
                                            <TextInput
                                                style={styles.inputStyle}
                                                placeholder="请输入社保卡密码"
                                                placeholderTextColor={'#b4b4b4'}
                                                value={this.state.sscPwd}
                                                maxLength={6}
                                                secureTextEntry={true}
                                                keyboardType='number-pad'
                                                onChangeText={newText => this.handleInputSscPwdtext(newText)}>
                                            </TextInput>
                                        </View>
                                        {/* <View style={{ flex: 1 }}>
                                        </View> */}
                                    ...
                                    <View style={[styles.containerStyle, { marginBottom: 0 }]}>
                                        ...
                                        {ViewUtils.getConfirmButton(() => this.commitData(), "确定挂失")}
                                    </View>
                                </View>
                    ...
                    <Modal
                        ...
                        >
                            <CommitResultView onTimeOut={() =>
                                this.jump2AnswerPage(common.CONST_BUSINESS_COMPLETE_SSC_LOSS)
                            } />
