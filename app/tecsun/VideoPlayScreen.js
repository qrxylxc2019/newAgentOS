...
export default class VideoPlayScreen extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      // videoUrl: "https://zhiliao.e-tecsun.com/file/group1/M00/00/35/rBAAL2KxjEGAITPOAB7PtX4tiNg414.mp4",
    ...
    return (
      <View style={styles.container} onLayout={this._onLayout}>
        <View style={{ width: this.state.videoWidth, height: this.state.videoHeight, backgroundColor: '#000000' }}>
                ...
                this.state.isPlaying ? null :
                  <TouchableWithoutFeedback onPress={() => { this.onPressPlayButton() }}>
                    <Image
                      ...
                      source={require('../../img/icon_video_play.png')}
                    />
          ...
          <TouchableWithoutFeedback onPress={() => { this.candelPlay() }}>
            <View
              style={{
                position: 'absolute',
                top: 10,
              ...
              }}>
              {
                ...
                //     <Image
                //       style={styles.playButton}
                //       source={require('../../assets/image/popup_cancel_btn.png')}
                //     />
                //   </TouchableWithoutFeedback>
              }
            </View>
              ...
              <View style={[styles.control, { width: this.state.videoWidth }]}>
                <TouchableOpacity activeOpacity={0.3} onPress={() => { 
                  ...
                  <Image
                    ...
                    source={this.state.isPlaying ? require('../../img/icon_control_pause.png') : require('../../img/icon_control_play.png')}
                  />
                </TouchableOpacity>
  ...
  candelPlay() {
    this.pauseVideo()
    console.log('>>>>>>>>>> candelPlay');
    //ldw 退出
    this.hideVideoSurface()
  }
  ...
  _onBuffering = () => {
    console.log('ldw 视频缓冲中...')
  };

  _onLoaded = (data) => {
    console.log('ldw 视频加载完成');
    this.setState({
  ...
  hideVideoSurface = () => {
    console.log('ldw hideVideoSurface');
    setTimeout(
      () => {
        //ldw 退出
